...
public class Student extends User implements Enrollable, Gradable, Comparable<Student> {
    ...
    public void submitAssignment(Assignment a) {
        ...
        System.out.println("Assignment " + a.getTitle() + " is successfully submitted for course " + selectedCourse.getName() + ".");
    }
